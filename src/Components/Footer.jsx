...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-stone-900 via-stone-800 to-stone-900 border-t border-stone-700/50 pt-16 pb-8 text-stone-300 font-sans relative overflow-hidden">
      {/* Background Pattern */}
